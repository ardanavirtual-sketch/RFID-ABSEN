...
// const simulateButton = document.getElementById('simulate-tap'); // Dihapus
...
function resetStatus() {
    ...
    statusMessage.textContent = portConnection ? 'Reader Siap. Tap Kartu.' : 'Menunggu Koneksi Serial...';
    ...
    // Perbarui status tombol koneksi
    if (portConnection) {
        ...
        readerStatusHint.textContent = 'Klik tombol di bawah untuk menyambungkan reader.';
    }
}
 ...
 * @param {string} rfidId - ID kartu yang diterima dari reader.
 */
